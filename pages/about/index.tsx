      ...
      <Container>
        <div className="space-y-6">
          <h1 className="text-2xl font-bold">
            Hey, I'm a Tech Engineer at UBS. I enjoy working with
          ...
          <p>As a frontend developer, I usually works with various JavaScript frameworks including React, Angular, Vue and Vanila JavaScript.</p>
